...
@section('content')
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-6">
                <form action="{{ route('inventary.listByCategory') }}" method="GET">
                                ...
                                <tbody>
                                    @foreach ($categories as $category )
                                           <tr>
                                            ...
                                            <th class="text-center ">{{ $category->product_code }}</th>
                                            <th class="text-center ">{{ $category->product_name }}</th>
                                            <th class="text-center ">{{ $category->product_stock }} un.</th>
                                            <th class="text-center ">{{ $category->product_price }} c/u</th>
                                          </tr>
                                    @endforeach
